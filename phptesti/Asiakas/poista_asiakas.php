<?php
 // Otetaan tiedosto mukaan joka pitää sisällään luokan, jonka avulla saamme yhteyden tietokantaan.
    ...
    $asiakasID = null; // Alustetaan asiakasID muuttuja
    ...
    // Tallennetaan piilotetun (input kentän type="hidden") kentän arvo muuttujaan asiakasID
    if ( !empty($_POST)) {
