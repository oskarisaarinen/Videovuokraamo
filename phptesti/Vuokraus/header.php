        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
                        ...
                        echo ' ">
                            <a class="nav-link" href="/phptesti/Asiakas/asiakas.php">Asiakas <span class="sr-only">(current)</span></a>
                        </li>';
                        echo '<li class="nav-item '; 
                        echo ($valikko==='video')?'active':'';
                        echo ' ">
                            <a class="nav-link" href="/phptesti/Video/video.php">Video</a>
                        </li>';
                        echo '<li class="nav-item '; 
                        echo ($valikko==='vuokraus')?'active':'';
                        echo ' ">
                            <a class="nav-link" href="/phptesti/Vuokraus/vuokraus.php">Vuokraus</a>
                        </li>';
                        echo '<li class="nav-item '; 
                        echo ($valikko==='myyja')?'active':'';
                        echo ' ">
                            <a class="nav-link" href="/phptesti/Myyja/myyja.php">Myyjä</a>
                        </li>
            ...
            if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
                ...
                echo '<a class="nav-link" href="../Kirjautuminen/sisaan.php">Kirjaudu <span class="oi oi-account-login"></span></a>';
            }
            ?>    
...
<?php
    ...
    if ( $_SERVER["PHP_SELF"] != "/phptesti/index.php" ){
        if ( $_SERVER["PHP_SELF"] != "/phptesti/Kirjautuminen/sisaan.php" ){
            if(!isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] != true){
                header("location: phptesti/Kirjautuminen/sisaan.php");
                exit;
            }
        }
    }
